...
$(call inherit-product-if-exists, vendor/Cubot/cubotx9/cubotx9-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/Cubot/cubotx9/overlay

LOCAL_PATH := device/Cubot/cubotx9
